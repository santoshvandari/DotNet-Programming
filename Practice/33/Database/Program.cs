/*
PRovided that a mysql database named "University" with table named "Student" with following columns (Rollnumber as int, Name as varchar(50),Department as varchar(50),Address as varcahr(50), and Tution_fee as float). Write c# program to connect to the database and insert 5 student records and display the student record form University database who's Department is 'Computer Application'.
*/
...
class Program{
    public static void Main(){
        ...
        MySqlDatReader reader = readcmd.ExecuteReader();
